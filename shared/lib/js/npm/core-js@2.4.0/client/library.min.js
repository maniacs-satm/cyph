...
(function(process) {
  !function(b, c, a) {
    ...
    !function(b) {
      ...
      var s = b(2),
          ...
          y = D && J(function() {
            return 7 != l(j({}, "a", {get: function() {
                return j(this, "a", {value: 7}).a;
              }})).a;
          }) ? function(c, a, d) {
            var b = H(g, a);
            b && delete g[a], j(c, a, d), b && c !== g && j(g, a, b);
          } : j,
          R = function(a) {
            var b = h[a] = l(d[i]);
            return b._k = a, b;
          },
          w = k && "symbol" == typeof d.iterator ? function(a) {
          ...
          Q = function propertyIsEnumerable(a) {
            var b = V.call(this, a = z(a, !0));
            return this === g && c(h, a) && !c(m, a) ? !1 : b || !c(this, a) || !c(h, a) || c(this, e) && this[e][a] ? b : !0;
          },
          M = function getOwnPropertyDescriptor(b, a) {
            if (b = t(b), a = z(a, !0), b !== g || !c(h, a) || c(m, a)) {
              var d = H(b, a);
              return !d || !c(h, a) || c(b, e) && b[e][a] || (d.enumerable = !0), d;
            }
          },
      ...
      k || (d = function Symbol() {
        ...
        var b = ba(arguments.length > 0 ? arguments[0] : a),
            f = function(a) {
      ...
      }), u && f(f.S + f.F * (!k || J(function() {
        var a = d();
        return "[null]" != v([a]) || "{}" != v({a: a}) || "{}" != v(Object(a));
          ...
          if (e !== a && !w(e)) {
            for (var b,
              ...
              d.push(arguments[f++]);
            return b = d[1], "function" == typeof b && (c = b), !c && X(b) || (b = function(b, a) {
              return c && (a = c.call(this, b, a)), w(a) ? void 0 : a;
            }), d[1] = b, v.apply(u, d);
          }
        }}), d[i][L] || b(10)(d[i], L, d[i].valueOf), B(d, "Symbol"), B(Math, "Math", !0), B(s.JSON, "JSON", !0);
    }, function(a, d) {
      ...
      var j = a(8),
          ...
          d = f.exports = function(d, m, t, r, s) {
            ...
            if ("function" != typeof o)
              throw TypeError(d + " is not iterable!");
            if (k(o)) {
              for (q = h(d.length); q > f; f++)
                if (a = m ? p(g(l = d[f])[0], l[1]) : p(d[f]), a === c || a === b)
                  return a;
            } else
              for (n = o.call(d); !(l = n.next()).done; )
                if (a = e(n, p, l.value, m), a === c || a === b)
                  return a;
          };
      ...
      var b = a(6),
          ...
          d = a(12),
          e = Function.apply;
      b(b.S, "Reflect", {apply: function apply(a, b, f) {
      ...
      b(b.S + b.F * a(5)(function() {
        ...
        return !(Reflect.construct(function() {}, [], F) instanceof F);
          ...
          c(b), f(a);
          var i = 3 > arguments.length ? b : c(arguments[2]);
          if (b == i) {
            switch (a.length) {
              case 0:
                return new b;
 ...
 while (a = e(a));
      ...
      var q = b(6),
          ...
          m = function(c, f) {
            i(c), this._c = a, this._o = c, c = new l(this);
            try {
              var b = f(c),
                  g = b;
              null != b && ("function" == typeof b.unsubscribe ? b = function() {
                g.unsubscribe();
              } : h(b), this._c = b);
            } catch (j) {
      ...
      f(c.prototype, {
        ...
        forEach: function forEach(a) {
          var b = this;
          return new (s.Promise || r.Promise)(function(d, c) {
            h(a);
            var e = b.subscribe({
              next: function(b) {
                try {
        ...
        return this;
      }), q(q.G, {Observable: c}), b(183)("Observable");
    }, function(d, e, b) {
      var a = b(6),
          c = b(187);
      a(a.G + a.B, {
 ...
 while (!d(e, c = g[b._i++]));
      ...
      var c = a(276),
          b = a(6);
      a(7)._ = c._ = c._ || {}, b(b.P + b.F, "Function", {part: a(275)});
    }, function(c, d, b) {
      var a = b(6);
