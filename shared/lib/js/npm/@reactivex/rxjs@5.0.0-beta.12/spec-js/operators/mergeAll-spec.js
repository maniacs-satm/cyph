...
describe('Observable.prototype.mergeAll', function() {
  ...
  it('should merge all observables in an observable', function() {
    var e1 = Observable.from([Observable.of('a'), Observable.of('b'), Observable.of('c')]);
    var expected = '(abc|)';
    expectObservable(e1.mergeAll()).toBe(expected);
  });
  it('should throw if any child observable throws', function() {
    var e1 = Observable.from([Observable.of('a'), Observable.throw('error'), Observable.of('c')]);
    var expected = '(a#)';
    expectObservable(e1.mergeAll()).toBe(expected);
  });
  ...
  it('should merge all promises in an observable', function(done) {
    var e1 = Rx.Observable.from([new Promise(function(res) {
      res('a');
    ...
    var expected = ['a', 'b', 'c', 'd'];
    var res = [];
    e1.mergeAll().subscribe(function(x) {
      res.push(x);
    }, function(err) {
