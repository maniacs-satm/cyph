...
describe('Observable.prototype.switch', function() {
  ...
  it('should switch to each immediately-scheduled inner Observable', function(done) {
    ...
    var r = [1, 4, 5, 6];
    var i = 0;
    Observable.of(a, b, queueScheduler).switch().subscribe(function(x) {
  ...
  it('should handle an observable of promises', function(done) {
    var expected = [3];
    Observable.of(Promise.resolve(1), Promise.resolve(2), Promise.resolve(3)).switch().subscribe(function(x) {
  ...
  it('should handle an observable of promises, where last rejects', function(done) {
    Observable.of(Promise.resolve(1), Promise.resolve(2), Promise.reject(3)).switch().subscribe(function() {
  ...
  it('should handle an observable with Arrays in it', function() {
    ...
    var completed = false;
    Observable.of(Observable.never(), Observable.never(), [1, 2, 3, 4]).switch().subscribe(function(x) {
      chai_1.expect(x).to.equal(expected.shift());
    }, null, function() {
      completed = true;
      chai_1.expect(expected.length).to.equal(0);
