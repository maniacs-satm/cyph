...
describe('Observable.prototype.combineAll', function() {
  asDiagram('combineAll')('should combine events from two observables', function() {
    ...
    var expected = '-----------------A-B--C---|';
    var result = outer.combineAll(function(a, b) {
  ...
  it('should work with two nevers', function() {
    ...
    var e2subs = '^';
    var expected = '-';
    var result = Observable.of(e1, e2).combineAll(function(x, y) {
      return x + y;
    });
    expectObservable(result).toBe(expected);
  ...
  it('should work with hot-single and hot-empty', function() {
    ...
    var e2subs = '^   !';
    var expected = '----|';
    var result = Observable.of(e2, e1).combineAll(function(x, y) {
      return x + y;
    });
    expectObservable(result).toBe(expected);
    expectSubscriptions(e1.subscriptions).toBe(e1subs);
  ...
  it('should combine 3 observables', function() {
    ...
    var e3subs = '^         !';
    var expected = '-----wxyz-|';
    var result = Observable.of(e1, e2, e3).combineAll(function(x, y, z) {
      return x + y + z;
    });
    expectObservable(result).toBe(expected, {
      w: 'bfi',
  ...
  it('should handle throw after complete left', function() {
    ...
    var rightSubs = '^        !';
    var expected = '---------#';
    var result = Observable.of(left, right).combineAll(function(x, y) {
      return x + y;
    });
