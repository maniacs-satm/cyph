...
describe('Observable.prototype.zip', function() {
  ...
  it('should zip the provided observables', function(done) {
    ...
    var i = 0;
    Observable.from(['a', 'b', 'c']).zip(Observable.from([1, 2, 3]), function(a, b) {
      return a + b;
  ...
  describe('with iterables', function() {
    ...
    it('should only call `next` as needed', function() {
      ...
      Observable.of(1, 2, 3).zip(myIterator).subscribe();
  ...
  it('should combine two observables and selector', function() {
    ...
    var bsubs = '^';
    var expected = '---x---y---z';
    expectObservable(a.zip(b, function(e1, e2) {
      return e1 + e2;
    })).toBe(expected, {
      x: '14',
      y: '25',
  ...
  it('should work with n-ary symmetric selector', function() {
    ...
    var c = hot('---1-^---3---6-|  ');
    var expected = '----x---y-|  ';
    var observable = a.zip(b, c, function(r0, r1, r2) {
      return [r0, r1, r2];
    });
  ...
  it('should work with some data asymmetric 1', function() {
    ...
    expectObservable(a.zip(b, function(r1, r2) {
      return r1 + r2;
    })).toBe(expected, {
      a: '12',
      b: '34',
  ...
  it('should not break unsubscription chain when unsubscribed explicitly', function() {
    ...
    var bsubs = '^        !';
    var expected = '---x---y--';
    var r = a.mergeMap(function(x) {
      return Observable.of(x);
    }).zip(b).mergeMap(function(x) {
      return Observable.of(x);
    });
