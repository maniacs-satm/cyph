...
describe('Observable.prototype.combineLatest', function() {
  asDiagram('combineLatest')('should combine events from two cold observables', function() {
    ...
    var result = e1.combineLatest(e2, function(a, b) {
  ...
  it('should work with two nevers', function() {
    ...
    var e2subs = '^';
    var expected = '-';
    var result = e1.combineLatest(e2, function(x, y) {
      return x + y;
    });
    expectObservable(result).toBe(expected);
  ...
  it('should work with hot-single and hot-empty', function() {
    ...
    var e2subs = '^   !';
    var expected = '----|';
    var result = e2.combineLatest(e1, function(x, y) {
      return x + y;
    });
    expectObservable(result).toBe(expected, values);
    expectSubscriptions(e1.subscriptions).toBe(e1subs);
  ...
  it('should accept array of observables', function() {
    ...
    var e3subs = '^         !';
    var expected = '-----wxyz-|';
    var result = e1.combineLatest([e2, e3], function(x, y, z) {
      return x + y + z;
    });
    expectObservable(result).toBe(expected, {
      w: 'bfi',
  ...
  it('should handle throw after complete left', function() {
    ...
    var rightSubs = '^        !';
    var expected = '---------#';
    var result = left.combineLatest(right, function(x, y) {
      return x + y;
    });
