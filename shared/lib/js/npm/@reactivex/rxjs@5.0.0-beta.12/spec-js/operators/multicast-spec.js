...
describe('Observable.prototype.multicast', function() {
  asDiagram('multicast(() => new Subject())')('should mirror a simple source Observable', function() {
    ...
    var sourceSubs = '^              !';
    var multicasted = source.multicast(function() {
      return new Subject();
    });
  ...
  it('should not break unsubscription chains when result is unsubscribed explicitly', function() {
    var source = cold('-1-2-3----4-|');
    var sourceSubs = '^        !   ';
    var multicasted = source.mergeMap(function(x) {
  ...
  describe('when given a subject factory', function() {
    ...
    it('should not throw ObjectUnsubscribedError when used in ' + 'a switchMap', function(done) {
      var source = Observable.of(1, 2, 3).multicast(function() {
        return new Subject();
      }).refCount();
      var expected = ['a1', 'a2', 'a3', 'b1', 'b2', 'b3', 'c1', 'c2', 'c3'];
      Observable.of('a', 'b', 'c').switchMap(function(letter) {
  ...
  describe('when given a subject', function() {
    it('should not throw ObjectUnsubscribedError when used in ' + 'a switchMap', function(done) {
      var source = Observable.of(1, 2, 3).multicast(new Subject()).refCount();
