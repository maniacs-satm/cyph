...
describe('Observable.prototype.partition', function() {
  ...
  asDiagram('partition(x => x % 2 === 1)')('should partition an observable of ' + 'integers into even and odd', function() {
    var e1 = hot('--1-2---3------4--5---6--|');
    var e1subs = '^                        !';
    var expected = ['--1-----3---------5------|', '----2----------4------6--|'];
    var result = e1.partition(function(x) {
      return x % 2 === 1;
    });
  ...
  it('should not break unsubscription chains when result is unsubscribed explicitly', function() {
    ...
    var result = e1.mergeMap(function(x) {
      ...
      return observable.mergeMap(function(x) {
        return Observable.of(x);
      });
    });
