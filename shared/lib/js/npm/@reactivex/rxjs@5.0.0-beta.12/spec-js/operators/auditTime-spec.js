...
describe('Observable.prototype.auditTime', function() {
  ...
  it('should auditTime events by 50 time units', function(done) {
    Observable.of(1, 2, 3).auditTime(50).subscribe(function(x) {
  ...
  it('should auditTime events multiple times', function() {
    ...
    Observable.concat(Observable.timer(0, 10, rxTestScheduler).take(3).map(function(x) {
      ...
      return '2-' + x;
    })).auditTime(50, rxTestScheduler).subscribe(function(x) {
  ...
  it('should not break unsubscription chains when result is unsubscribed explicitly', function() {
    ...
    }).auditTime(50, rxTestScheduler).mergeMap(function(x) {
      return Observable.of(x);
    });
