...
describe('Observable.prototype.zipAll', function() {
  asDiagram('zipAll')('should combine paired events from two observables', function() {
    ...
    var expected = '-----------------A----B-|';
    var result = outer.zipAll(function(a, b) {
  ...
  it('should take all observables from the source and zip them', function(done) {
    ...
    var i = 0;
    Observable.of(Observable.of('a', 'b', 'c'), Observable.of(1, 2, 3)).zipAll(function(a, b) {
      return a + b;
  ...
  describe('with iterables', function() {
    ...
    it('should only call `next` as needed', function() {
      ...
      Observable.of(Observable.of(1, 2, 3), myIterator).zipAll().subscribe();
  ...
  it('should combine two observables and selector', function() {
    ...
    var bsubs = '^';
    var expected = '---x---y---z';
    expectObservable(Observable.of(a, b).zipAll(function(e1, e2) {
      return e1 + e2;
    })).toBe(expected, {
      x: '14',
      y: '25',
  ...
  it('should work with n-ary symmetric selector', function() {
    ...
    var c = hot('---1-^---3---6-|  ');
    var expected = '----x---y-|  ';
    var observable = Observable.of(a, b, c).zipAll(function(r0, r1, r2) {
      return [r0, r1, r2];
    });
  ...
  it('should work with some data asymmetric 1', function() {
    ...
    expectObservable(Observable.of(a, b).zipAll(function(r1, r2) {
      return r1 + r2;
    })).toBe(expected, {
      a: '12',
      b: '34',
  ...
  it('should zip until one child terminates', function(done) {
    var expected = ['a1', 'b2'];
    var i = 0;
    Observable.of(Observable.of('a', 'b', 'c'), Observable.of(1, 2)).zipAll(function(a, b) {
      return a + b;
    }).subscribe(function(x) {
      chai_1.expect(x).to.equal(expected[i++]);
    }, null, done);
  ...
  it('should not break unsubscription chain when unsubscribed explicitly', function() {
    ...
    var r = Observable.of(a, b).mergeMap(function(x) {
      return Observable.of(x);
    }).zipAll().mergeMap(function(x) {
      return Observable.of(x);
    });
