...
describe('Observable.prototype.takeWhile', function() {
  asDiagram('takeWhile(x => x < 4)')('should take all elements until predicate is false', function() {
    ...
    var sourceSubs = '^      !         ';
    var expected = '-2--3--|         ';
    var result = source.takeWhile(function(v) {
      return +v < 4;
    });
  ...
  it('should take all elements with predicate returns true', function() {
    ...
    expectObservable(e1.takeWhile(function() {
      return true;
    })).toBe(expected);
  ...
  it('should not complete when source never completes', function() {
    ...
    var e1subs = '^';
    var expected = '-';
    var result = e1.takeWhile(function() {
      return true;
    });
    expectObservable(result).toBe(expected);
    expectSubscriptions(e1.subscriptions).toBe(e1subs);
  ...
  it('should raise error when source throws', function() {
    ...
    var subs = '(^!)';
    var expected = '#';
    expectObservable(source.takeWhile(function() {
      return true;
    })).toBe(expected);
  ...
  it('should not break unsubscription chain when unsubscribed explicitly', function() {
    ...
    }).takeWhile(predicate).mergeMap(function(x) {
      return Observable.of(x);
    });
