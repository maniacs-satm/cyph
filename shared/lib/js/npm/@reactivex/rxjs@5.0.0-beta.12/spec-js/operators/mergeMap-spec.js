...
describe('Observable.prototype.mergeMap', function() {
  ...
  it('should mergeMap values to resolved promises with resultSelector', function(done) {
    ...
    var results = [];
    var expectedCalls = [[4, [4, 0], 0, 0], [3, [3, 1], 1, 0], [2, [2, 2], 2, 0], [1, [1, 3], 3, 0]];
  ...
  it('should support type signatures', function() {
    type(function() {
      var o;
      var a1 = o.mergeMap(function(x) {
        return x.toString();
      });
      var a2 = o.mergeMap(function(x) {
        return x.toString();
      }, 3);
      var a3 = o.mergeMap(function(x) {
        return x.toString();
      }, function(o, i) {
        return ({
          o: o,
