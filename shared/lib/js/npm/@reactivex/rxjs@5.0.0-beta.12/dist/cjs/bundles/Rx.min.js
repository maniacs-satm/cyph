...
(function(process) {
  (function(z) {
    "object" === typeof exports && "undefined" !== typeof module ? module.exports = z() : "function" === typeof define && define.amd ? define([], z) : ("undefined" !== typeof window ? window : "undefined" !== typeof global ? global : "undefined" !== typeof self ? self : this).Rx = z();
  })(function() {
    return function a(b, f, h) {
      ...
      13: [function(a, b, f) {
          ...
          function d(m, n, b) {
            ...
            switch (arguments.length) {
              ...
              case 1:
                ...
                if ("object" === typeof m) {
                  m instanceof d ? (this.destination = m, this.destination.add(this)) : (this.syncErrorThrowable = !0, this.destination = new e(this, m));
                  break;
                }
              default:
        ...
        var e = function(a) {
          function d(d, e, b, g) {
            ...
            var f;
            d = this;
            l.isFunction(e) ? f = e : e && (d = e, f = e.next, b = e.error, g = e.complete, l.isFunction(d.unsubscribe) && this.add(d.unsubscribe.bind(d)), d.unsubscribe = this.unsubscribe.bind(this));
            this._context = d;
            this._next = f;
            this._error = b;
            this._complete = g;
          ...
          d.prototype.error = function(a) {
            if (!this.isStopped) {
              var d = this._parent;
              if (this._error)
                d.syncErrorThrowable ? this.__tryOrSetError(d, this._error, a) : this.__tryOrUnsub(this._error, a), this.unsubscribe();
              else if (d.syncErrorThrowable)
                d.syncErrorValue = a, d.syncErrorThrown = !0, this.unsubscribe();
              else
        ...
        a = function() {
          ...
          a.prototype.unsubscribe = function() {
            ...
            if (!this.closed) {
              ...
              if (a)
                throw new c.UnsubscriptionError(d);
            }
          };
        ...
        a = function(a) {
          ...
          c.prototype._subscribe = function(a) {
            var e = this.array,
                ...
                b = this.scheduler;
            if (b)
              return b.schedule(c.dispatch, 0, {
                array: e,
                index: 0,
                count: n,
                subscriber: a
      ...
      146: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          m.prototype._subscribe = function(a) {
            ...
            k || (k = this.subject = new c.AsyncSubject, f = function r() {
              for (var a = [],
              ...
              var c = r.source,
                  d = c.selector,
                  c = c.subject;
              d ? (a = g.tryCatch(d).apply(this, a), a === e.errorObject ? c.error(e.errorObject.e) : (c.next(a), c.complete())) : (c.next(1 === a.length ? a[0] : a), c.complete());
            }, f.source = this, g.tryCatch(d).apply(this, b.concat(f)) === e.errorObject && k.error(e.errorObject.e));
              ...
              var r = m.subject = new c.AsyncSubject,
                  x = function E() {
                    ...
                    var m = E.source,
                        c = m.selector,
                        m = m.subject;
                    c ? (a = g.tryCatch(c).apply(this, a), a === e.errorObject ? d.add(k.schedule(l, 0, {
                      err: e.errorObject.e,
                      subject: m
                    })) : d.add(k.schedule(h, 0, {
                      value: a,
                      subject: m
                    }))) : d.add(k.schedule(h, 0, {
      ...
      147: [function(a, b, f) {
            ...
            var w = g.subject = new d.AsyncSubject,
                r = function D() {
                  ...
                  var m = D.source,
                      ...
                      m = m.subject,
                      g = a.shift();
                  g ? m.error(g) : d ? (a = e.tryCatch(d).apply(this, a), a === c.errorObject ? b.add(v.schedule(k, 0, {
                    err: c.errorObject.e,
                    subject: m
                  })) : b.add(v.schedule(l, 0, {
                    value: a,
                    subject: m
                  }))) : b.add(v.schedule(l, 0, {
                    value: 1 === a.length ? a[0] : a,
        ...
        a = function(a) {
          ...
          b.prototype._subscribe = function(a) {
            ...
            n || (n = this.subject = new d.AsyncSubject, g = function x() {
              for (var a = [],
                  d = 0; d < arguments.length; d++)
                a[d - 0] = arguments[d];
              var m = x.source,
                  ...
                  m = m.subject,
                  b = a.shift();
              b ? m.error(b) : d ? (a = e.tryCatch(d).apply(this, a), a === c.errorObject ? m.error(c.errorObject.e) : (m.next(a), m.complete())) : (m.next(1 === a.length ? a[0] : a), m.complete());
            }, g.source = this, e.tryCatch(m).apply(this, b.concat(g)) === c.errorObject && n.error(c.errorObject.e));
            ...
            d = function(a) {
              ...
              d.prototype._unsubscribe = function() {
                ...
                if (a) {
                  this.connectable = null;
                  var d = a._refCount;
                  0 >= d ? this.connection = null : (a._refCount = d - 1, 1 < d ? this.connection = null : (d = this.connection, a = a._connection, this.connection = null, !a || d && a !== d || a.unsubscribe()));
                } else
        ...
        var e = function(a) {
          ...
          d.prototype.notifyComplete = function(a) {
            var d = this.destination,
                ...
                b = this.values,
                g = b.length;
            a._hasValue ? (this.completed++, this.completed === g && (c === g && (a = e ? e.apply(this, b) : b, d.next(a)), d.complete())) : d.complete();
          };
          return d;
        }(a.OuterSubscriber);
      }, {
        ...
        a = function(a) {
          ...
          d.setupSubscription = function(a, c, b, g, f) {
            ...
            if (a && "[object NodeList]" === a.toString() || a && "[object HTMLCollection]" === a.toString())
              ...
              a && "function" === typeof a.addEventListener && "function" === typeof a.removeEventListener ? (a.addEventListener(c, b, f), k = function() {
                return a.removeEventListener(c, b);
              }) : a && "function" === typeof a.on && "function" === typeof a.off ? (a.on(c, b), k = function() {
                return a.off(c, b);
              }) : a && "function" === typeof a.addListener && "function" === typeof a.removeListener && (a.addListener(c, b), k = function() {
          ...
          d.prototype._subscribe = function(a) {
            var c = this.selector;
            d.setupSubscription(this.sourceObj, this.eventName, c ? function() {
              for (var d = [],
                  e = 0; e < arguments.length; e++)
                d[e - 0] = arguments[e];
      ...
      155: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          b.create = function(a, f) {
            if (null != a) {
              if ("function" === typeof a[t.$$observable])
              ...
              if (a && "number" === typeof a.length)
                return new d.ArrayLikeObservable(a, f);
            }
      ...
      158: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          e.prototype._subscribe = function(a) {
            var d = this.period;
            a.add(this.scheduler.schedule(e.dispatch, d, {
              index: 0,
              subscriber: a,
              period: d
            }));
        ...
        a = function(a) {
          ...
          c.dispatch = function(a) {
            var d = a.index,
                c = a.iterator,
                e = a.subscriber;
            a.hasError ? e.error(a.error) : (c = c.next(), c.done ? e.complete() : (e.next(c.value), a.index = d + 1, e.closed || this.schedule(a)));
          };
          c.prototype._subscribe = function(a) {
            var d = this.iterator,
                e = this.scheduler;
            if (e)
              return e.schedule(c.dispatch, 0, {
                index: 0,
                iterator: d,
                subscriber: a
              });
      ...
      167: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          d.prototype._subscribe = function(a) {
            return this.scheduler.schedule(d.dispatch, this.dueTime, {
              index: 0,
              period: this.period,
              subscriber: a
            });
      ...
      174: [function(a, b, f) {
        ...
        function e(a, d) {
          return (new p({
            ...
            responseType: "json",
            headers: d
          })).lift(new t.MapOperator(function(a, d) {
            return a.response;
          }, null));
        }
            ...
            var e = {
              ...
              createXHR: function() {
                ...
                if (this.crossDomain)
                  ...
                  else if (d.root.XDomainRequest)
                    a = new d.root.XDomainRequest;
                  else
                    throw Error("CORS is not supported by your browser");
                else if (d.root.XMLHttpRequest)
                  a = new d.root.XMLHttpRequest;
                else {
                  var c = void 0;
                  try {
        ...
        var v = function(a) {
          function e(c, b) {
            ...
            "Content-Type" in m || d.root.FormData && b.body instanceof d.root.FormData || "undefined" === typeof b.body || (m["Content-Type"] = "application/x-www-form-urlencoded; charset=UTF-8");
          ...
          e.prototype.serializeBody = function(a, c) {
            if (!a || "string" === typeof a || d.root.FormData && a instanceof d.root.FormData)
              return a;
            if (c) {
              var e = c.indexOf(";");
          ...
          e.prototype.setupEvents = function(a, c) {
            ...
            a.upload && "withCredentials" in a && d.root.XDomainRequest && (e && (a.onprogress = function u(a) {
            ...
            a.onreadystatechange = function u(a) {
              ...
              if (4 === this.readyState) {
                ...
                0 === b && (b = m ? 200 : 0);
                200 <= b && 300 > b ? (c && c.complete(), d.next(a), d.complete()) : (c && c.error(a), d.error(new r("ajax error " + b, this, e)));
              }
            };
        ...
        var w = function() {
          return function(a, d, c) {
            ...
            switch (this.responseType) {
              case "json":
                this.response = "response" in d ? d.responseType ? d.response : JSON.parse(d.response || d.responseText || "null") : JSON.parse(d.responseText || "null");
                break;
              case "xml":
          ...
          b.prototype._connectSocket = function() {
            ...
            g.onopen = function(c) {
              ...
              a.destination = k.Subscriber.create(function(a) {
                ...
                e && e.next(void 0);
                c && c.code ? g.close(c.code, c.reason) : b.error(new TypeError("WebSocketSubject.error must be called with an object with an error code, and an optional reason: { code: number, reason: string }"));
      ...
      199: [function(a, b, f) {
        ...
        function l(a) {
          var d = a.bufferCreationInterval,
              ...
              b = a.scheduler,
              m = e.openContext();
          e.closed || (e.add(m.closeAction = b.schedule(k, c, {
            subscriber: e,
            context: m
          })), this.schedule(a, d));
        }
          ...
          return a;
            ...
            n = function(a) {
              function d(c, e, b, m, g) {
                ...
                this.contexts = [];
                c = this.openContext();
                (this.timespanOnly = null == b || 0 > b) ? this.add(c.closeAction = g.schedule(h, e, {
                  subscriber: this,
                  context: c,
                  bufferTimeSpan: e
                })) : (m = {
                  ...
                  subscriber: this,
                  scheduler: g
                }, this.add(c.closeAction = g.schedule(k, e, {
                  subscriber: this,
                  context: c
              ...
              d.prototype.onBufferFull = function(a) {
                ...
                if (this.timespanOnly) {
                  ...
                  this.add(a.closeAction = this.scheduler.schedule(h, d, {
                    subscriber: this,
                    context: a,
                    bufferTimeSpan: d
                  }));
          ...
          return a;
            ...
            d = function(a) {
              ...
              d.prototype.openBuffer = function() {
                ...
                d === g.errorObject ? this.error(g.errorObject.e) : (this.closingSubscription = a = new l.Subscription, this.add(a), this.subscribing = !0, a.add(e.subscribeToResult(this, d)), this.subscribing = !1);
              };
              return d;
            }(b.OuterSubscriber);
      }, {
            ...
            c = function(a) {
              ...
              c.dispatch = function(a) {
                for (var d = a.source,
                    c = d.queue,
                    e = a.scheduler,
                    b = a.destination; 0 < c.length && 0 >= c[0].time - e.now(); )
          ...
          c.prototype._next = function(a) {
            ...
            if (d.closed)
              ...
              if (this.active < this.concurrent) {
                ...
                b === k.errorObject ? d.error(k.errorObject.e) : this.scheduler ? this.add(this.scheduler.schedule(c.dispatch, 0, {
                  subscriber: this,
                  result: b,
                  value: a,
                  index: e
      ...
      232: [function(a, b, f) {
            ...
            m = function(a) {
              ...
              d.prototype._group = function(a, d) {
                ...
                if (this.elementSelector)
                  ...
                  f = a;
                if (!m && (b.set(d, m = new g.Subject), b = new q(d, m, this), this.destination.next(b), this.durationSelector)) {
                  b = void 0;
                  try {
        ...
        var t = function(a) {
          ...
          d.prototype.unsubscribe = function() {
            var d = this.parent;
            d.closed || this.closed || (a.prototype.unsubscribe.call(this), --d.count, 0 === d.count && d.attemptedToUnsubscribe && d.unsubscribe());
          };
          return d;
        }(l.Subscription);
      }, {
      ...
      241: [function(a, b, f) {
        function h() {
          ...
          var c = Number.POSITIVE_INFINITY,
              d = null,
              b = a[a.length - 1];
          g.isScheduler(b) ? (d = a.pop(), 1 < a.length && "number" === typeof a[a.length - 1] && (c = a.pop())) : "number" === typeof b && (c = a.pop());
      ...
      245: [function(a, b, f) {
        ...
        var c = function(a) {
          ...
          c.prototype.notifyComplete = function(a) {
            ...
            this.remove(a);
            this.active--;
            0 < d.length ? this._next(d.shift()) : 0 === this.active && this.hasCompleted && (!1 === this.hasValue && this.destination.next(this.acc), this.destination.complete());
          };
          return c;
        }(a.OuterSubscriber);
      ...
      266: [function(a, b, f) {
        ...
        var e = function(a) {
          ...
          b.prototype.checkValues = function() {
            for (var a = this._a,
                d = this._b,
                c = this.comparor; 0 < a.length && 0 < d.length; ) {
              var b = a.shift(),
                  e = d.shift();
      ...
      272: [function(a, b, f) {
        ...
        f.startWith = function() {
          ...
          var b = a.length;
          return 1 === b ? g.concatStatic(new l.ScalarObservable(a[0], d), this) : 1 < b ? g.concatStatic(new h.ArrayObservable(a, d), this) : g.concatStatic(new k.EmptyObservable(d), this);
        };
      }, {
        "../observable/ArrayObservable": 145,
        "../observable/EmptyObservable": 150,
        ...
        var n = function(a) {
          ...
          b.prototype._next = function(a) {
            var b = this.iterators,
                c = this.index++;
            g.isArray(a) ? b.push(new t(a)) : "function" === typeof a[d.$$iterator] ? b.push(new q(a[d.$$iterator]())) : b.push(new p(this.destination, this, a, c));
          };
          b.prototype._complete = function() {
      ...
      298: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          b.prototype.requestAsyncId = function(b, c, d) {
            void 0 === d && (d = 0);
            if (null !== d && 0 < d)
              return a.prototype.requestAsyncId.call(this, b, c, d);
            b.actions.push(this);
      ...
      315: [function(a, b, f) {
        ...
        l = function(a) {
          ...
          b.prototype._subscribe = function(b) {
            ...
            b.add(new k.Subscription(function() {
          ...
          b.prototype.expectObservable = function(a, c) {
            ...
            this.schedule(function() {
              h = a.subscribe(function(a) {
                ...
                e.push({
                  frame: d.frame,
                  notification: k.Notification.createNext(b)
                });
              }, function(a) {
                e.push({
                  frame: d.frame,
