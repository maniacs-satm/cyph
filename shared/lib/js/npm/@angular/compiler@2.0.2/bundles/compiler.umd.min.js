...
(function(process) {
  !function(global, factory) {
    ...
    function bindRenderOutputs(eventListeners) {
      eventListeners.forEach(function(listener) {
        listener.eventPhase ? listener.listenToAnimation() : listener.listenToRenderer();
      });
    }
        ...
        TemplateParseVisitor = function() {
          ...
          return TemplateParseVisitor.prototype._reportError = function(message, sourceSpan, level) {
            ...
            if (preparsedElement.type === PreparsedElementType.NG_CONTENT)
              ...
              parsedElement = new ElementAst(nodeName, attrs, elementProps, events, references, providerContext.transformedDirectiveAsts, providerContext.transformProviders, providerContext.transformedHasViewContainer, children, hasInlineTemplates ? null : ngContentIndex_1, element.sourceSpan), this._findComponentDirectives(directiveAsts).forEach(function(componentDirectiveAst) {
            ...
            hostListeners && Object.keys(hostListeners).forEach(function(propName) {
              ...
              isString(expression) ? _this._parseEventOrAnimationEvent(propName, expression, sourceSpan, [], targetEventAsts) : _this._reportError('Value of the host listener "' + propName + '" needs to be a string representing an expression but got "' + expression + '" (' + typeof expression + ")", sourceSpan);
            });
    ...
    var _ComponentIndex,
        ...
        CompileEventListener = function() {
          ...
          return CompileEventListener.getOrCreate = function(compileElement, eventTarget, eventName, eventPhase, targetEventListeners) {
            ...
            var outputListener = THIS_EXPR.callMethod("eventHandler", [THIS_EXPR.prop(this._methodName).callMethod(BuiltinMethod.Bind, [THIS_EXPR])]),
                stmt = THIS_EXPR.callMethod("registerAnimationOutput", [this.compileElement.renderNode, literal(this.eventName), literal(this.eventPhase), outputListener]).toStmt();
        ...
        ViewBinderVisitor = function() {
          ...
          return ViewBinderVisitor.prototype.visitBoundText = function(ast, parent) {
            ...
            }), bindRenderInputs(ast.inputs, compileElement), bindRenderOutputs(eventListeners), ast.directives.forEach(function(directiveAst) {
    ...
    var DirectiveNormalizer = function() {
      ...
      return DirectiveNormalizer.prototype.clearCache = function() {
            ...
            return Object.keys(propertyMetadata).forEach(function(propName) {
              propertyMetadata[propName].forEach(function(a) {
                if (a instanceof _angular_core.Input)
                  ...
                  var hostBinding = a;
                  hostBinding.hostPropertyName ? host["[" + hostBinding.hostPropertyName + "]"] = propName : host["[" + propName + "]"] = propName;
        ...
        _CompileValueConverter = function(_super) {
          ...
          return __extends$15(_CompileValueConverter, _super), _CompileValueConverter.prototype.visitOther = function(value, targetIdentifiers) {
            var identifier;
        ...
        _TsEmitterVisitor = function(_super) {
          ...
          return __extends$16(_TsEmitterVisitor, _super), _TsEmitterVisitor.prototype.visitType = function(t, ctx, defaultType) {
        ...
        AbstractJsEmitterVisitor = function(_super) {
          ...
          return __extends$18(AbstractJsEmitterVisitor, _super), AbstractJsEmitterVisitor.prototype.visitDeclareClassStmt = function(stmt, ctx) {
            var _this = this;
        ...
        JitEmitterVisitor = function(_super) {
          ...
          return __extends$17(JitEmitterVisitor, _super), JitEmitterVisitor.prototype.getArgs = function() {
            for (var result = {},
    ...
    var __extends$19 = this && this.__extends || function(d, b) {
      ...
      d.prototype = null === b ? Object.create(b) : (__.prototype = b.prototype, new __);
        ...
        DomElementSchemaRegistry = function(_super) {
          ...
          return __extends$19(DomElementSchemaRegistry, _super), DomElementSchemaRegistry.prototype.hasProperty = function(tagName, propName, schemaMetas) {
