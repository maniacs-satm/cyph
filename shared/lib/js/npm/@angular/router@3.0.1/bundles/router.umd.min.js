  ...
  !function(global, factory) {
    ...
    function updateSegmentGroup(segmentGroup, startIndex, commands) {
      ...
      var m = prefixedWith(segmentGroup, startIndex, commands),
          slicedCommands = commands.slice(m.lastIndex);
    ...
    function setupRouter(ref, urlSerializer, outletMap, location, injector, loader, compiler, config, opts) {
      if (void 0 === opts && (opts = {}), 0 == ref.componentTypes.length)
        throw new Error("Bootstrap at least one component before injecting Router.");
      var componentType = ref.componentTypes[0],
          r = new Router(componentType, urlSerializer, outletMap, location, injector, loader, compiler, flatten(config));
    ...
    function initialRouterNavigation(router, opts) {
      return function() {
        opts.initialNavigation === !1 ? router.setUpLocationChangeListener() : router.initialNavigation();
      };
    }
      ...
      d.prototype = null === b ? Object.create(b) : (__.prototype = b.prototype, new __);
        ...
        ApplyRedirects = function() {
          ...
          return ApplyRedirects.prototype.apply = function() {
            ...
            return "**" === route.path ? this.expandWildCardWithParamsAgainstRouteUsingRedirect(route) : this.expandRegularSegmentAgainstRouteUsingRedirect(injector, segmentGroup, routes, route, segments, outlet);
            ...
            return route.redirectTo.startsWith("/") ? absoluteRedirect(newSegments) : rxjs_observable_of.of(new UrlSegmentGroup(newSegments, {}));
        ...
        Router = function() {
          ...
          return Router.prototype.initialNavigation = function() {
          ...
          return RouterLinkActive.prototype.ngAfterContentInit = function() {
            ...
            if (this.links && this.linksWithHrefs && this.router.navigated) {
              var isActiveLinks = this.reduceList(this.links),
                  isActiveLinksWithHrefs = this.reduceList(this.linksWithHrefs);
