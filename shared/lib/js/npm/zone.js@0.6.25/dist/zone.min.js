...
(function(process) {
  !function(e, t) {
    ...
    function p(e) {
      var t = [],
          n = e.wtf;
      n ? t = F.split(",").map(function(e) {
        return "HTML" + e + "Element";
      }).concat(H) : e[R] ? t.push(R) : t = H;
    ...
    function g(e, t, n) {
      return n.configurable = !0, n.configurable || (e[W] || q(e, W, {
        writable: !0,
        value: {}
      }), e[W][t] = !0), n;
    }
          ...
          C = function() {
            ...
            return e.resolve = function(e) {
              ...
              var n = new this.constructor(null),
                  r = d.current;
              return this[S] == O ? this[P].push(r, n, e, t) : p(this, r, n, e, t), n;
    ...
    _(K, N, G, "Timeout"), _(K, N, G, "Interval"), _(K, N, G, "Immediate"), _(K, "request", "cancel", "AnimationFrame"), _(K, "mozRequest", "mozCancel", "AnimationFrame"), _(K, "webkitRequest", "webkitCancel", "AnimationFrame");
    ...
    p(K), m(K), c("MutationObserver"), c("WebKitMutationObserver"), c("FileReader"), h(), k(K), D(K);
    var Q = E("xhrTask"),
        Y = E("xhrSync");
